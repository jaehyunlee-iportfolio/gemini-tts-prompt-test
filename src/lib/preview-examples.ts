...
/**
 * Gemini 2.5 Pro TTS의 프롬프트 컨트롤 폭을 다양하게 경험해볼 수 있도록
 * 액센트·신체 상태·역할·감정 4축으로 큐레이션했습니다.
 * chipLabel은 짧게(≤9자), body는 한 줄로 구체적 디렉션을 담습니다.
 */
export const PREVIEW_EXAMPLE_PROMPTS: ReadonlyArray<{ title: string; body: string }> = [
  // — 액센트 · 발음
  {
    title: "한국 아이 영어",
...
export const PREVIEW_EXAMPLE_TEXTS: ReadonlyArray<string> = [
  "Look! The whole sky is filled with shooting stars tonight.",
  "I can't believe we actually found a real treasure map!",
  "Once upon a time, in a quiet little village by the sea...",
  "Did you see that? My favorite team just scored the winning goal!",
  "Hello! My name is Erin. What's your name?",
];
